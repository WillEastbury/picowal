...
// Register parameter: single byte (ILI9488 SPI = 8-bit interface)
...
// Pixel data: 3 bytes per pixel (RGB666 over SPI)
// ILI9488 SPI interface always uses 18-bit color (3 bytes per pixel)
